...
class Course(models.Model):
    course_logo_url = models.CharField(max_length=1000)#,default='SOMEURL')
    ...
    #course_topics=models.

    def __str__(self):
        template = '{0.auther_name} {0.course_title} {0.course_description}{0.course_logo_url}{0.course_created_timestamp}'
